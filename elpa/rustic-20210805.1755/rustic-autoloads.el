...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rustic-babel" '("org-babel-execute:rust" "rustic-" "crate-dependencies" "cargo-toml-dependencies")))

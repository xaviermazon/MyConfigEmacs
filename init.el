...
(custom-set-variables
 ...
 '(objed-cursor-color "#CC9393")
	'(package-selected-packages
		 '(editorconfig fill-column-indicator company-erlang erlang eglot neotree rustic flycheck-rust flycheck yasnippet company lsp-ui lsp-mode rust-mode markdown-mode doom-themes magit))
